...
--desc user_tables selecct table name from user tables where table name in ('depart','emple');
--desc table_name depart emple
--desc user_constraints user_cons_columns select constraint name tablename from user constraint
